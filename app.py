...
st.set_page_config(page_title="Health Management: Nutrition Calculator & Diet Planner",
                   layout="wide")
st.image('logo2.png')
st.header("AI Food Nutrition Analyzer And Calculator")

######################################################################################
section_choice1 = st.radio("Choose Section:", ("Nutrition Analyzer","Nutritionist AI"))


#If choice is nutrition calculator
if section_choice1 == "Nutrition Analyzer":
    ...
    if submit:
        ...
        st.subheader("Nutritionist AI: ")
        st.write(response)


#If choice is diet planner
if section_choice1 == "Nutritionist AI":
    ...
    """
    ##if the button is clicked
    input_diet = st.text_area("Your personal AI Nutritionist!")
    submit1 = st.button("Guide and Plan!")
    if submit1:
